...
const (
	Service_Method_FullMethodName = "/user.Service/Method"
)
...
func (c *serviceClient) Method(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	...
	out := new(Response)
	err := c.cc.Invoke(ctx, Service_Method_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) Method(context.Context, *Request) (*Response, error) {
...
func _Service_Method_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_Method_FullMethodName,
	}
